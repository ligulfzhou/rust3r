export const solanaRustAnchorKeyToCode: { [key: string]: string; } = {
  "get_validators": `
...
export const solanaRustAnchorKeyToTitle: { [key: string]: string; } = {
...
export const solanaRustAnchorCodeKeys = [
  'get_validators',
  // 'create_spl_token',
  // 'get_spl_associated_token_account',
  // 'mint_spl_token_to_PDA',
